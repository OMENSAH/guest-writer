...
You can create these with the command `ng g c name_of_component`. I will name my components as `welcome, dashboard and post-dialog`. Since we have two modules in the src folder, the command will not be 
